...
const experiences = [
	{
		...
		endDate: "Okto 2022",
		company: "Community",
		position: "Lua Encryptor Developer",
		type: "Seasonal",
		location: "Jakarta, Indonesia",
		description:
			"Developed and maintained Lua-based encryption and obfuscation scripts for community projects, focusing on securing source code and preventing unauthorized modification. Worked closely with users to customize encryption logic, optimize script performance, and troubleshoot compatibility issues across different Lua environments.",
		skills: ["Lua", "Seller", "Mentoring"],
	},
	{
		id: 2,
		startDate: "Des 2024",
		endDate: "Now",
		company: "WH-Server",
		position: "Head Server & Map Developer",
		type: "Part Time",
		location: "Jakarta, Indonesia",
		description:
			"Responsible for managing and developing a Minecraft Bedrock server, including server configuration, performance optimization, and custom map development. Designed and implemented gameplay systems, handled server-side scripting and JSON configurations, and collaborated with the team to ensure a stable, engaging, and scalable multiplayer experience.",
		skills: ["Javascript", "Json", "Graphical Texture", "Prompt Engineering"],
	},
];

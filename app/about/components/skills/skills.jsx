...
const skillCategories = {
	web: {
		...
		icon: CodepenIcon,
		description: "Building logic and fine gameplay in Minecraft",
		languages: [
			"JavaScript",
			"NodeJS"
		],
		tools: ["Amazon Cloud Service", "Git", "Github", "Quickedit", "Blockbench", "Docker"],
	},
	api: {
		title: "Web Development",
		icon: WebhookIcon,
		description: "Creating & Designing Proper and Optimize Website",
		languages: [
			"NodeJS",
			"ExpressJS",
			"HTML",
		...
		tools: ["Vercel", "Docker", "Amazon Cloud Service", "Digital Ocean", "Git", "Github", "Google Cloud", "IBM Cloud"],
	},
};

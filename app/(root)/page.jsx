...
// Cari baris ini dan ubah faDiscord menjadi faLetterboxd
							...
							<div className="mx-auto container grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden md:px-20">
								<motion.div
									...
									<motion.p
										...
										Hi! I&rsquo;am Danish, A high school student with a strong interest
                                        in programming and experience as a server manager for the
                                        Minecraft server wonghoa.my.id. Actively learning full-stack 
                                        web development, focusing on building modern, scalable, 
									...
									<motion.div
										...
										<Button variation="primary">
											<a href="https://wa.me/6281389733597" target="_blank" rel="noopener noreferrer">WhatsApp</a>
										</Button>
							...
							<div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
								...
								<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
									...
									<motion.p
										...
										<a href="mailto:danishfiqhiarrazy@gmail.com?subject=Hello&body=Hello Danish,">
											danishfiqhiarrazy@gmail.com
										</a>
									</motion.p>
									{/* icons */}
									<div className="flex justify-center items-center space-x-4">
										<motion.a
											href="mailto:danishfiqhiarrazy@gmail.com?subject=Hello&body=Hello Danish,"
										...
										<motion.a
											href="https://www.instagram.com/dansz.f.a/"
											target="_blank"
											rel="noopener noreferrer"
											className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
											initial={{ opacity: 0, y: 40 }}
										...
										<motion.a
											href="https://www.tiktok.com/@danzxdnz?_r=1&_t=ZS-93R6SObIkEq"
											target="_blank"
											rel="noopener noreferrer"
											className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
											initial={{ opacity: 0, y: 40 }}
										...
										<motion.a
											...
											<FontAwesomeIcon icon={faLetterboxd} className="text-3xl" />
										</motion.a>
									</div>
								</div>
							</div>
